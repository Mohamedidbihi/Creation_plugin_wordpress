# Création d'un plugin from scratch wordpress

```
1 - créer un nouveau dossier dans le répertoire wordpress/wp-content/plugins/.

2 - créer une page avec un nom MedPlugins avec une extension php.
...
7 - ajouter page footer.php qui contien code source et form pour ajouter copyright et les lien des réseaux sociaux sur footer.
